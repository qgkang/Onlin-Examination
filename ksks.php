...
$query=mysql_query("select * from tb_user where online_number='".$_SESSION['online_number']."' and online_pt='1'");
...
<tr>
  ...
  <?php 
	$query1=mysql_query("select * from tb_kt where kt_lb='$kt_lbes' and kt_lx='1' and kt_small_lb='$kt_small_lb'");
	$y=1;
	$fen1=0; 
...
$y++;
  ...
  <?php 
$query2=mysql_query("select * from tb_kt where kt_lb='$kt_lbes' and kt_lx='2' and kt_small_lb='$kt_small_lb'");
$z=1;
$fen2=0; 
...
$z++;
 ...
 <?php
$query3=mysql_query("select * from tb_kt where kt_lb='$kt_lbes' and kt_lx='3' and kt_small_lb='$kt_small_lb'");
$w=1;
$fen3=0; 
...
$grade_result=mysql_query($grade);
}
?>
</body>
</html>
