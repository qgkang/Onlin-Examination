...
$query=mysql_query("insert into tb_user(online_user,online_tel,online_address,online_number,online_pass) values('".$_GET['online_user']."','".$_GET['online_tel']."','".$_GET['online_address']."','".$online_number."','".$online_pass."')");
if($query==true){
